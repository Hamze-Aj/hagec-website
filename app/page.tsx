...
const featuredProjects = [
  ...
  {
    id: 2,
    title: "Solar-Pump Water Supply System",
    category: "Solar-Pump",
    location: "Fik Zone, Somali Region",
    size: "—",
    status: "Completed",
    image: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=800&q=80",
    slug: "solar-pump-water-supply",
  },
  {
    id: 3,
    title: "Waberi Irrigation & Drainage Study",
    category: "Hydrology",
    location: "Gode Zone, Somali Region",
    size: "800 HA",
    status: "Ongoing",
    image: "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?w=800&q=80",
    slug: "waberi-irrigation-study",
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 container-custom text-white text-center py-24">
          <div className="badge mb-6 inline-flex text-white border-white/30 bg-white/10 backdrop-blur-sm">
            <span className="w-2 h-2 rounded-full bg-[#FF6600]" />
            Jigjiga, Somali Region · Ethiopia
          </div>

          <h1
            className="text-[clamp(36px,6vw,72px)] font-900 leading-[1.1] mb-6 max-w-5xl mx-auto"
            style={{ fontWeight: 900, letterSpacing: "-0.025em", textShadow: "0 2px 16px rgba(0,0,0,0.3)" }}
          >
            Sustainable Engineering Solutions for
            <br />
            <span style={{ color: "#FF6600" }}>Water Resources & Infrastructure</span>
            <br />
            in the Horn of Africa
          </h1>

          <p className="text-[18px] text-white/85 max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((svc, i) => (
              <div
                key={i}
                className="service-card bg-white rounded-xl p-6 border border-[#E2E8F0] card-hover group animate-on-scroll"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
            {featuredProjects.map((project, i) => (
              <Link
                ...
                className="group block rounded-2xl overflow-hidden bg-white border border-[#E2E8F0] card-hover animate-on-scroll"
              ...
              >
                ...
                <div className="p-5">
                  <h3
                    className="text-[16px] font-700 text-[#0A2540] mb-2 group-hover:text-[#0066CC] transition-colors"
                    style={{ fontWeight: 700 }}
                  >
                    {project.title}
                  </h3>
      ...
      >
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 gap-4 animate-on-scroll" style={{ animationDelay: "0.15s" }}>
              {reasons.map((reason, i) => (
                <div
                  key={i}
                  className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/15"
                >
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {clients.map((client, i) => (
              <div
                key={i}
                className="flex flex-col items-center justify-center p-6 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] hover:border-[#0066CC] hover:shadow-card transition-all group animate-on-scroll"
                style={{ animationDelay: `${i * 0.05}s` }}
              >
                <div
